...
Au Québec, bien qu'il n'existe aucune obligation de publier des données ouvertes, plusieurs ministères, collectivités et organismes de la société civile participent au partenariat [Données Québec](https://www.donneesquebec.ca/) et publient des [jeux de données](https://www.donneesquebec.ca/recherche/dataset) par son portail Web.  Plusieurs autres provinces dont [l'Ontario](https://data.ontario.ca/fr/) et la [Colombie-Brittanique](https://catalogue.data.gov.bc.ca) opèrent des portails similaires pour leurs données gouvernementales.  Pour des données du gouvernement fédéral il existe le [Portail du gouvernement ouvert](https://rechercher.ouvert.canada.ca/donneesouvertes/).
