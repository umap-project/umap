...
!!! note
    L'enregistrement se fait sur les serveurs d'OpenStreetMap dans le cas d'une utilisation d'uMap OSM ou ceux de l'ANCT si uMap pour les agents publics est utilisé.
