const locale = {
    "(area: {measure})": "(พื้นที่: {measure})",
    "(length: {measure})": "(ความยาว: {measure})",
    "# one hash for main heading": "# แฮชหนึ่งอันสำหรับหัวข้อหลัก",
    "## two hashes for second heading": "## แฮชสองตัวสำหรับหัวข้อที่สอง",
    "### three hashes for third heading": "### แฮช 3 ตัวสำหรับหัวข้อที่สาม",
    "**double star for bold**": "**ดอกจันทร์คู่สำหรับตัวหนา**",
    "*single star for italic*": "*ใส่ดอกจันทร์หนึ่งตัวสำหรับตัวเอียง*",
    "--- for a horizontal rule": "--- สำหรับเส้นแบ่งแนวนอน",
    "1 day": "1 วัน",
    "1 hour": "1 ชั่วโมง",
    "5 min": "5 นาที",
    "A comma separated list of numbers that defines the stroke dash pattern. Ex.: \"5, 10, 15\".": "รายการตัวเลขที่คั่นด้วยเครื่องหมายคอมมาซึ่งกำหนดรูปแบบขีดเส้นขีด ตัวอย่าง: \"5, 10, 15\"",
    "About": "เกี่ยวกับ",
    "Action not allowed :(": "ไม่อนุญาตให้ดำเนินการ :(",
    "Activate slideshow mode": "เปิดใช้งานโหมดสไลด์โชว์",
    "Add a layer": "เพิ่มเลเยอร์",
    "Add a line to the current multi": "เพิ่มบรรทัดให้กับมัลติปัจจุบัน",
    ...
    "Back to preview": "ย้อนกลับไปยังตัวอย่าง",
