const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "מסגרת פנימית עם גובה מותאם (בפיקסלים): {{{https://iframe.url.com|גובה}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "מסגרת פנימית עם גובה ורוחב מותאמים (בפיקסלים): {{{https://iframe.url.com|גובה*רוחב}}}",
    "iframe": "מסגרת פנימית",
    "Iframe: {{{https://iframe.url.com}}}": "מסגרת פנימית: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "תמונה עם רוחב מותאם (בפיקסלים): {{https://image.url.com|רוחב}}",
    ...
    "Link to…": "קישור אל…",
    "Link with text: [[https://example.com|text of the link]]": "קישור עם טקסט: [[https://example.com|הטקסט של הקישור]]",
