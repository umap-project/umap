var locale = {
    ...
    "Circle": "Kružnica",
    "Clone this map": "Poduplaj ovu kartu",
    "Default": "Default",
    "Delete": "Obriši",
    "Delete this feature": "Brisanje ovog elementa",
    "Disable editing": "Disable editing",
    "Display on load": "Prikaži kod učitavanja",
    "Do you want to display a minimap?": "Želite li prikazati malu kartu?",
    "Do you want to display popup footer?": "Želite li prikazati skočni prozor u podnožju?",
    ...
    "To zoom": "Do uvećanja",
    "Untitled layer": "Bezimeni sloj",
    "Untitled map": "Bezimena karta",
    "Update permissions and editors": "Ažuriraj dozvole i urednike",
    "Url": "Url",
    ...
    "fill opacity": "prozirnost ispune",
    "inherit": "naslijedi",
    "licence": "licenca",
    "name": "ime",
    "no": "ne",
    ...
    "Custom background": "Posebna pozadina",
    "Help": "Pomoć",
    "Image: {{http://image.url.com}}": "slika {{http://slika.url.hr}}",
    "Link with text: [[http://example.com|text of the link]]": "Link sa tekstom: [[http://primjer.hr|tekst linka]]",
    ...
    "max zoom": "maksimalno uvećanje",
    "min zoom": "minimalno uvećanje",
    ...
    "next": "next",
    "previous": "previous",
    "Measure distances": "Izmjeri udaljenosti",
    "NM": "NM",
