var locale = {
    ...
    "Are you sure you want to clone this map and all its datalayers?": "Na pewno chcesz sklonować tą mapę razem z jej warstwami?",
    "Are you sure you want to delete the feature?": "Na pewno chcesz usunąć obiekt?",
    ...
    "Center map on your location": "Wyśrodkuje mapę na twojej lokalizacji",
    ...
    "Do you want to display a minimap?": "Chcesz wyświetlać małą mapę?",
    "Do you want to display popup footer?": "Chcesz wyświetlacz stopkę dymka?",
    "Do you want to display the scale control?": "Chcesz wyświetlać kontrolkę ze skalą?",
    ...
    "Embed and share this map": "Osadź i udostępnij tą mapę",
    ...
    "Zoom to this feature": "Przybliż to tego obiektu",
    "color": "kolor",
    ...
    "--- for an horizontal rule": "--- dla poziomej linii",
    "All properties are imported.": "Zaimportowano wszystkie właściwości",
    ...
    "Link with text: [[http://example.com|text of the link]]": "Link z tekstem: [[http://przyklad.pl|tekst zamiast linku]]",
    "Properties imported:": "Zaimportowane właściwości:",
    ...
    "You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each markers.": "Możesz używać właściwości obiektu jako zmiennych np. z \"http://myserver.org/images/{name}.png\", zmienna {name} zostanie zastąpiona przez wartość \"name\" dla każdego znacznika.",
    ...
    "Do you want to display a caption bar?": "Chcesz wyświetlić pasek z nagłówkiem?",
    "Do you want to display a panel on load?": "Chcesz wyświetlić panel po załadowaniu?",
    "None": "Brak",
    "by": " ",
    ...
    "Do you want to display the «more» control?": "Chcesz wyświetlić «więcej» kontrolek?",
    "Auto": "Auto",
    ...
    "Continue line (Ctrl-click)": "Dokończ linię (Ctrl+kliknij)",
    "Start a hole here": "Zacznij dziurę tutaj",
    "Click last point to finish shape": "Kliknij w ostatni punkt aby zakończyć rysowanie",
    ...
    "Add a line to the current multi": "Dodaj linie do wybranego multipoligonu",
    "Add a polygon to the current multi": "Dodaj poligon do wybranego multipoligonu",
    "Click to edit": "Kliknij aby edytować",
    "Continue line": "Dokończ linię",
    "Delete this shape": "Usuń tę figurę",
    "Make main shape": "Narysuj główny kształt",
    "Merge lines": "Połącz linie",
    "Remove shape from the multi": "Usuń obiekt z wybranego multipoligonu",
    "Transfer shape to edited feature": "Transfer shape to edited feature",
    "next": "następne",
    "previous": "poprzednie",
    "Measure distances": "Oblicz odległości",
    "NM": "Mm",
    ...
    "Are you sure you want to delete this layer?": "Czy jesteś pewien, że chcesz usunąć tą warstwę?",
