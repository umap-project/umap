const locale = {
    ...
    "--- for a horizontal rule": "Pozioma linia: ---",
    "1 day": "1 dzień",
    "1 hour": "1 godzina",
    "5 min": "5 minut",
    ...
    "Custom overlay": "Własna nakładka",
    ...
    "If false, the polygon or line will act as a part of the underlying map.": "Jeżeli fałsz, wielokąt lub linia będą zachowywały się jak część bazowej mapy.",
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Ramka z podaną wysokością (w pikselach) {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Ramka z podaną wysokością i szerokością (w pikselach): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Ramka: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Obrazek z własną szerokością (w pikselach) {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Obrazek: {{https://image.url.com}}",
    ...
    "Latest feature": "Najnowszy obiekt",
    ...
    "Link to view the map": "Link do oglądania mapy",
    "Link to…": "Łącze do...",
    "Link with text: [[https://example.com|text of the link]]": "Link z tekstem: [[https://example.com|tekst]]",
    ...
    "On the top": "Na górze",
    "Only visible layers' data": "Tylko dane widocznych warstw",
    ...
    "previous": "poprzednie",
    "Problem in the response": "Problem w odpowiedzi",
    ...
    "See on OpenStreetMap": "Zobacz na OpenStreetMap",
    ...
    "Simple link: [[https://example.com]]": "Prosty link: [[https://example.com]]",
    "Simplify": "Uprość",
    ...
    "Type a place name or coordinates": "Wpisz nazwę miejsca lub współrzędne",
    "Type char or paste emoji": "Wpisz znak lub wklej emoji",
    ...
    "Update who can see and edit the map": "Zaktualizuj kto może zobaczyć i edytować mapę",
    "Url": "Adres URL",
    "URL": "URL",
    ...
    "{area}&#8239;yd&sup2;": "{area} jardów kwadratowych",
    ...
    "Edit map name and caption": "Edytuj nazwę mapy i opis",
    "Map advanced properties": "Zaawansowane właściwości mapy",
    "Edit map details": "Edytuj właściwości mapy",
    "Back to browser": "Z powrotem do przeglądarki",
