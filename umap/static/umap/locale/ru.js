const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe с указанием высоты (в пикселях): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe с заданной высотой и шириной (в px): {{{https://iframe.url.com|height*width}}}",
    "iframe": "Iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Изображение с указанием ширины (в пикселях): {{https://image.url.com|width}}",
    ...
    "Link to…": "Связать с...",
    "Link with text: [[https://example.com|text of the link]]": "Ссылка с текстом: [[https://example.com|текст для ссылки]]",
    ...
    "Simple link: [[https://example.com]]": "Простая ссылка: [[https://example.com]]",
    "Simplify": "Упростить",
