const locale = {
    ...
    "Image with custom width (in px): {{https://image.url.com|width}}": "Özel genişliğe sahip resim (piksel cinsinden): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Görüntü: {{https://image.url.com}}",
    ...
    "Link with text: [[https://example.com|text of the link]]": "Metin ile bağlantı: [[https://example.com|text of the link]]",
    ...
    "Simple link: [[https://example.com]]": "Basit bağlantı: [[https://example.com]]",
