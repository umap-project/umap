const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe s vlastnou výškou (v px): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe s vlastnou výškou a šírkou (v px): {{{https://iframe.url.com|height*widht}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Obraz s vlastnou šírkou (v pixeloch): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Obrázok: {{https://url.obrazka.sk}}",
    ...
    "Link to…": "Odkaz na…",
    "Link with text: [[https://example.com|text of the link]]": "Odkaz s textom: [[https://priklad.sk|text odkazu]]",
    ...
    "Simple link: [[https://example.com]]": "Jednoduchý odkaz: [[https://priklad.sk]]",
