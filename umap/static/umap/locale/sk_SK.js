var locale = {
    ...
    "Ball": "Špendlík",
    "Bring feature to center": "Vycentruj mapu na objekt",
    ...
    "Zoom in": "Priblížiť",
    "Zoom out": "Oddialiť",
    "Zoom to layer extent": "Prispôsobiť priblíženie vrstve",
    ...
    "You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each markers.": "Môžete používať vlastnosti objektu ako premenné, napr. v \"http://mojserver.sk/obrazky/{name}.png\" je {name} nahradené hodnotou \"name\" každého objektu.",
    ...
    "Iframe export options": "Možnosti Iframe exportu",
    ...
    "Property to use for sorting features": "Vlastnosť použitá pre radenie objektov",
    ...
    "Measure distances": "Merať vzdialenosť",
    "NM": "NM",
    "kilometers": "kilometrov",
    "km": "km",
    "mi": "mi",
    "miles": "míľ",
    "nautical miles": "námorných míľ",
    "{area} acres": "{area} akrov",
    "{area} ha": "{area} ha",
    ...
    "Advanced transition": "Pokročilý prechod",
    ...
    "Only display label on mouse hover": "Zobraziť popis iba pri prejdení myšou",
