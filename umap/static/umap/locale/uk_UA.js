var locale = {
    ...
    "Iframe export options": "Параметри експорту для Iframe",
    ...
    "Property to use for sorting features": "Параметри для сортування об’єктів",
    ...
    "Symbol can be either a unicode caracter or an URL. You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each marker.": "Значок може бути як юнікод-символом так і URL. Ви можете використовувати параметри об'єктів як змінні. Наприклад, в \"http://myserver.org/images/{name}.png\", змінна {name} буде замінена значенням поля \"name\" кожної мітки на мапі.",
