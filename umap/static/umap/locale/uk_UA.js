const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe із зазначенням висоти (в пікселях): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe з власними висотою та шириною (у пікселях): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Зображення із зазначенням ширини (в пікселях): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Зображення: {{https://image.url.com}}",
    ...
    "Link to…": "Послатись…",
    "Link with text: [[https://example.com|text of the link]]": "Посилання з текстом: [[https://example.com|текст для посилання]]",
    ...
    "Simple link: [[https://example.com]]": "Просте посилання: [[https://example.com]]",
    "Simplify": "Спростити",
