var locale = {
    ...
    "Property to use for sorting features": "Eigindi til að nota við röðun fitja",
    ...
    "Symbol can be either a unicode caracter or an URL. You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each marker.": "Tákn getur verið annað hvort unicode-stafur eða URL-slóð. Þú getur haft eigindi fitja sem breytur: t.d.: með \"http://mittlén.org/myndir/{nafn}.png\", verður breytunni {nafn} skipt út fyrir gildið \"nafn\" í eigindum hvers merkis.",
    "TMS format": "TMS-snið",
