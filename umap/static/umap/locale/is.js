const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe með sérsniðinni hæð (í mynddílum/px): {{{https://iframe.url.com|hæð}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe með sérsniðinni hæð og breidd (í mynddílum/px): {{{https://iframe.url.com|hæð*breidd}}}",
    "iframe": "iFrame",
