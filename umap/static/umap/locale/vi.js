const locale = {
    ...
    "Do you want to display a minimap?": "Bạn có  muốn hiện thị bản đồ nhỏ hay không?",
    "Do you want to display a panel on load?": "Do you want to display a panel on load?",
    "Do you want to display popup footer?": "Bạn có muốn hiển thị thông báo ở dưới hay không?",
    "Do you want to display the scale control?": "Bạn có muốn hiện thị bảng mở rộng hay không?",
    ...
    "Advanced actions": "Hoat động nâng cao",
    ...
    "Are you sure you want to delete this map?": "Bạn có chắc muốn xóa bản đồ này?",
    ...
    "Empty": "Empty",
    "Enable editing": "Bật chức năng chỉnh sửa",
    ...
    "Filter…": "Filter…",
    "Format": "Định dạng",
    "From zoom": "Phóng to từ",
    "Full map data": "Full map data",
    "Go to «{feature}»": "Tới «{feature}»",
