const locale = {
    ...
    "The name of the property to use as feature label (eg.: \"nom\"). You can also use properties inside brackets to use more than one or mix with static content (eg.: \"&lcub;name&rcub; in &lcub;place&rcub;\")": "Il nome della proprietà da usare come etichetta per l’elemento (ad es. \"nome\"). Puoi anche usare proprietà tra parentesi per specificarne più di una oppure combinarle con contenuti statici (ad es. “&lcub;nome&rcub; in &lcub;luogo&rcub;”)",
