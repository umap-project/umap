const locale = {
    ...
    "Image with custom width (in px): {{https://image.url.com|width}}": "Immagine con larghezza personalizzata (width) (in px): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Immagini: {{https://image.url.com}}",
    ...
    "Link to…": "Link a…",
    "Link with text: [[https://example.com|text of the link]]": "Link con testo: [[https://example.com|testo del link]]",
    ...
    "Simple link: [[https://example.com]]": "Link semplice: [[https://example.com]]",
    "Simplify": "Semplifica",
