...
registerLocale('eu', {
    ...
    "Comma, tab or semi-colon separated values. SRS WGS84 is implied. Only Point geometries are imported. The import will look at the column headers for any mention of «lat» and «lon» at the beginning of the header, case insensitive. All other column are imported as properties.": "Koma, tabulazioa edo puntu eta koma bereizitako balioak. SRS WGS84 inplizitua dago. Puntuen geometriak bakarrik inportatzen dira. Inportazioak zutabeen goiburuak aztertuko ditu goiburuaren hasieran «lat» eta «lon» aipamenak egiteko, maiuskulak eta minuskulak bereizten dituena. Beste zutabe guztiak propietate gisa inportatzen dira.",
    ...
    "The name of the property to use as feature label (eg.: \"nom\"). You can also use properties inside brackets to use more than one or mix with static content (eg.: \"&lcub;name&rcub; in &lcub;place&rcub;\")": "Entitatearen etiketa gisa erabili beharreko propietatearen izena (adibidez: \"nom\"). Kortxeteen barneko propietateak ere erabil ditzakezu bat baino gehiago erabiltzeko edo eduki estatikoarekin nahasteko (adibidez: \"&lcub;name&rcub; in &lcub;place&rcub;\")",
    ...
    "key (eg. building)": "gakoa (adib. eraikina)",
    "!key (eg. !name)": "!gakoa (adib. !izena)",
    "key=value (eg. building=yes)": "gakoa=balioa (adib. eraikina=bai)",
    "key!=value (eg. building!=yes)": "gakoa!=balioa (adib. eraikina!=bai)",
    ...
    "Property name to compute circles": "Zirkuluak kalkulatzeko propietatearen izena",
    ...
    "zoom to data extent": "Zoom egin datuen neurrira",
    ...
    "Layer permalink": "Geruzaren esteka iraunkorra",
    ...
    "Tags": "Etiketak",
    "Geocode": "Geocode",
    "Display the back to home icon": "Bistaratu 'Etxera itzuli' ikonoa",
    "Do you want to display layer switcher in caption bar?": "Geruza-aldatzailea bistaratu nahi duzu epigrafeen barran?",
    "Simplify all geometries to points": "Sinplifikatu geometria guztiak puntuetara",
    "Back to list": "Itzuli zerrendara",
    "Toggle rule": "Aldatu araua",
    "Delete rule": "Ezabatu erregela",
    "Cannot save layer, please try again in a few minutes.": "Ezin da geruza gorde, saiatu berriro minutu batzuk barru.",
    "Activate collaborative live editing on this map. Other users must reload the map after changing this setting.": "Aktibatu zuzeneko edizio kolaboratiboa mapa honetan. Beste erabiltzaile batzuek mapa berriro kargatu behar dute ezarpen hau aldatu ondoren.",
    ...
    "Text offset": "Testu-desplazamendua",
    ...
    "From staff": "Langileen partetik",
    "From community": "Komunitatearen partetik",
    "You must select a template.": "Txantiloi bat aukeratu behar duzu",
    "Line decoration": "Lerroaren dekorazioa",
    ...
    "You have no registered template yet. You can add one by creating a new map and flagging it as \"template\".": "Oraindik ez duzu erregistratutako txantiloirik. Bat gehi dezakezu mapa berri bat sortuz eta \"txantiloi\" gisa markatuz.",
    "There is no recommended template yet. Recommended templates are the ones starred by uMap administrators.": "Oraindik ez dago gomendatutako txantiloirik. Gomendatutako txantiloiak uMap-eko administratzaileek izarrez markatutakoak dira.",
    "There is no public template yet.": "Oraindik ez dago txantiloi publikorik.",
    "Explore": "Arakatu",
    "Import data from public open data portals": "Inportatu datuak datu irekien atari publikoetatik",
    "Choose a portal": "Aukeratu atari bat",
    ...
    "Cannot process MultiPoint": "Ezin da MultiPoint prozesatu",
    ...
    "Will only affect raw and large circle icons.": "Zirkulu-ikono gordin eta handietan bakarrik eragingo du.",
    "Route": "Ibilbidea",
    "Display the print control": "Bistaratu inprimatzeko kontrola",
    "Compute isochrone from here": "Kalkulatu isokrona hemendik",
    ...
    "Profile": "Profila",
    "Compute elevations": "Kalkulatu kotak",
    "Route preference": "Ibilbide-hobespena",
    "Compute route": "Ibilbidea kalkulatu",
    "Walking": "Oinez",
    "Hiking": "Korrika",
    "By car": "Autoz",
    "Cycling": "Bizikletaz",
    ...
    "Add filter": "Gehitu irakazkia",
    "Min/Max": "Min/Max",
    "Multiple choices": "Aukera anitzak",
    "Exclusive choice": "Aukera esklusiboa",
    "Yes/No": "Bai/Ez",
    "Add a field prior to create a filter.": "Gehitu eremu bat iragazkia sortu aurretik.",
    "Edit this filter": "Aldatu iragazki hau",
    "Remove this filter": "Kendu iragazki hau",
    "Apply filter to": "Aplikatu iragazkia honi:",
    "Filter on": "Iragazkia martxan",
    "Human readable name of the filter": "Iragazkiaren izen irakurgarria",
    "Widget for the filter": "Iragazkirako trepeta",
    "Edit filter": "Aldatu iragazkia",
    "Edit this field": "Aldatu eremu hau",
    "all layers": "geruza guztiak",
    "single layer": "geruza bakarra",
    "unset": "ezarri gabea",
    "Filters will be displayed in the data browser to ease data selection.": "Iragazkiak datu-arakatzailean bistaratuko dira datuen aukeraketa errazteko.",
    ...
    "Manage field": "Kudeatu eremua",
    "Add filter for this field": "Gehitu iragazkia eremu honetan",
    "Name cannot be empty.": "Izena ezin da hutsik egon",
    "Anonymous map": "Mapa anonimoa",
    "Edit filter for this field": "Aldatu eremu honen iragazkia",
    "Hey, you created a map without an account!": "Erne, mapa konturik gabe sortu duzu!",
    "This map is anonymous, do you want to attach it to your account?": "Mapa hau anonimoa da. Erantsi nahi al diozu zure kontuari?",
    "The map has been upgraded to latest version, please save it.": "Mapa azken bertsiora eguneratu da, mesedez gorde.",
    "Elevation has been added!": "Altuera gehitu da!",
    "Mapillary": "Mapillary",
    "Wikidata": "Wikidata",
    "Wikipedia contributors": "Wikipediako laguntzaileak",
    "See on Wikipedia": "Ikusi Wikipedian",
    "Anonymous map: update who can see and edit it": "Mapa anonimoa: eguneratu nork ikusi eta edita dezakeen",
    "Login": "Hasi saioa",
    "Manage filters": "Kudeatu iragazkiak",
    "Map (all layers)": "Mapa (geruza guztiak)",
    "Add a filter for this field": "Gehitu iragazkia eremu honetarako",
    "Short text": "Testu laburra",
    "Text": "Testua",
    "Number": "Zenbakia",
    "Date": "Data",
    "Date and time": "Data eta ordua",
    "List of values": "Balioen zerrenda",
    "Yes / No": "Bai / Ez",
    "Select field to compute intensity": "Select field to compute intensity",
    "Optional intensity field to compute heatmap": "Aukerako intentsitate-eremua bero-mapa kalkulatzeko",
    "All layers": "Geruza guztiak",
    "Comma separated list of values": "Komaz bereizitako balioen zerrenda",
    "Share": "Partekatu",
    "Customized link": "Esteka pertsonalizatua",
    "Iframe": "Iframe",
    "№": "№",
    "Layers": "Geruzak",
    "Datalayers’ permissions": "Datalayers’ permissions",
    "Group’s permissions": "Taldearen baimenak",
    "Layer’s permissions": "Geruzaren baimenak",
    "This layer is a group": "Geruza hau talde bat da",
    "Groups can have children layers, but cannot have data.": "Taldeek haur-geruzak izan ditzakete, baina ezin dute daturik izan.",
    "Open in OpenStreetMap": "Ireki OpenStreetMap-en",
    "Add a group": "Gehitu talde bat",
    "Are you sure you want to delete this field?": "Ziur zaude eremu hau ezabatu nahi duzula?",
    "Group": "Taldea",
    "Parent group": "Talde gurasoa",
