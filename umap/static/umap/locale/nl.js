const locale = {
    ...
    "Image with custom width (in px): {{https://image.url.com|width}}": "Beeld met gespecifieerde (in px): {{https://image.url.com|width}}",
    ...
    "Link to…": "Link naar…",
    "Link with text: [[https://example.com|text of the link]]": "Link met tekst: [[https://example.com|text of the link]]",
    ...
    "Simple link: [[https://example.com]]": "Eenvoudige link: [[https://example.com]]",
