const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe määrätyn korkuisena (pikseleinä): {{{https://iframe.url.com|height}}}",
    ...
    "Image with custom width (in px): {{https://image.url.com|width}}": "Kuva määrätyn leveyisenä (pikseleinä): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Kuva: {{https://kuva.url.com}}",
    ...
    "Link with text: [[https://example.com|text of the link]]": "Hyperlinkki tekstillä: [[https://esimerkkisaitti.fi|linkin teksti]]",
    ...
    "Simple link: [[https://example.com]]": "Yksinkertainen linkki: [[https://esimerkki.fi]]",
