const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframeの縦幅を指定(ピクセル): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframeの縦幅および横幅を指定(ピクセル): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "画像の横幅カスタム値 (px): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "画像:  {{https://image.url.com}}",
    ...
    "Link to…": "リンク",
    "Link with text: [[https://example.com|text of the link]]": "テキストとリンク: [[https://example.com|リンクのテキスト]]",
    ...
    "Side panel": "サイドパネル",
    "Simple link: [[https://example.com]]": "シンプルリンク: [[https://example.com]]",
    "Simplify": "簡略化",
