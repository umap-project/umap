const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe con altura persoalizada (en píxeles): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe con alto e ancho (en px) persoalizado: {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Imaxe con anchura persoalizada (en píxeles): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Imaxe: {{https://image.url.com}}",
    ...
    "Link with text: [[https://example.com|text of the link]]": "Ligazón con texto: [[https://example.com|text of the link]]",
    ...
    "Simple link: [[https://example.com]]": "Ligazón sinxela: [[https://example.com]]",
