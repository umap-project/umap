const locale = {
    ...
    "Only visible layers' data": "Só os datos das capas visíbeis",
    "opacity": "opacidade",
    "Opacity": "Opacidade",
    ...
    "The name of the property to use as feature label (eg.: \"nom\"). You can also use properties inside brackets to use more than one or mix with static content (eg.: \"&lcub;name&rcub; in &lcub;place&rcub;\")": "O nome da propiedade que vai ser empregado como etiqueta do elemento (p. ex.: «nom»). Tamén podes usar propiedades entre corchetes para usar máis dunha ou mesturar con contido estático (p. ex.: «&lcub;name&rcub; en &lcub;place&rcub;»)",
    ...
    "Only geometry centers": "Só centros xeométricos",
