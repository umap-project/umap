const locale = {
    ...
    "Image with custom width (in px): {{https://image.url.com|width}}": "Imej dengan lebar tersuai (dalam px): {{https://image.url.com|width}}",
    ...
    "Link to…": "Pautkan ke…",
    "Link with text: [[https://example.com|text of the link]]": "Pautkan dengan tulisan: [[https://example.com|tulisan pautan]]",
