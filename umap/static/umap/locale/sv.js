var locale = {
    ...
    "Symbol can be either a unicode caracter or an URL. You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each marker.": "Symbolen kan vara antingen en unicode-karaktär eller en URL. Du kan använda objektattribut som variabler: ex. med \"https://minserver.org/bilder/{namn}.png\", kommer variabeln {namn} att ersättas med \"namn\"-värdet för varje objekt.",
