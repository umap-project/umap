const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe med specifik höjd (i pixlar): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe med specifik höjd och bredd (i pixlar): {{{https://iframe.url.com|height*width}}}",
    "iframe": "IFrame (inbäddad html-ram)",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe (inbäddad ram): {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Bild med specifik bredd (i pixlar): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Bild: {{https://image.url.com}}",
    ...
    "Link to…": "Länk till…",
    "Link with text: [[https://example.com|text of the link]]": "Hyperlänk med egen text: [[https://www.exempel.se|Länktext]]",
    ...
    "Simple link: [[https://example.com]]": "Enkel hyperlänk: [[https://www.exempel.se]]",
    "Simplify": "Förenkla",
