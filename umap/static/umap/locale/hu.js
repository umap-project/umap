const locale = {
    ...
    "The name of the property to use as feature label (eg.: \"nom\"). You can also use properties inside brackets to use more than one or mix with static content (eg.: \"&lcub;name&rcub; in &lcub;place&rcub;\")": "A tulajdonság neve, amelyet az objektum felirataként fog megjelenni (pl.: „név”). A tulajdonságokat kapcsos zárójelben is használhatja, ha többet szeretne használni, vagy statikus tartalommal keverné (pl.: &lcub;név&rcub; itt: &lcub;hely&rcub;).",
    ...
    "Back to browser": "Vissza a böngészéshez",
    ...
    "Open browser": "Adatok böngészése",
    ...
    "Browser: data": "Böngészés: adatok",
    "Browser: layers": "Böngészés: rétegek",
    "Browser: filters": "Böngészés: szűrők",
    ...
    "Display the open browser control": "'Adatok böngészése' vezérlő megjelenítése",
    ...
    "Load map template": "Térképsablon betöltése",
    "My templates": "Sablonjaim",
    ...
    "Loading a template will apply predefined styles and settings to your map": "Egy sablon betöltése előre meghatározott stílusokat és beállításokat fog alkalmazni a térképre.",
    "Load template with data": "Sablon betöltése adatokkal",
    "You have no registered template yet. You can add one by creating a new map and flagging it as \"template\".": "Még nincs regisztrált sablonja. Úgy hozhat létre egyet, ha készít egy új térképet, és azt megjelöli sablonnak.",
    "There is no recommended template yet. Recommended templates are the ones starred by uMap administrators.": "Egyelőre nincs ajánlott sablon. Egy sablon akkor lesz ajánlott, ha a uMap valamelyik adminisztrátora csillaggal megjelöli.",
    "There is no public template yet.": "Még nincs nyilvános sablon.",
    "Explore": "Felfedezés",
    "Import data from public open data portals": "Adatok importálása nyilvános nyíltadatportálról",
    ...
    "Skipping invalid geometry": "Érvénytelen geometria kihagyása",
    "Add filter": "Szűrő hozzáadása",
    "Min/Max": "min. / max.",
    "Multiple choices": "Többszörös választás",
    "Exclusive choice": "Egyszeres választás",
    "Yes/No": "igen / nem",
    "Add a field prior to create a filter.": "Szűrő létrehozásához először adjon meg egy mezőt.",
    "Edit this filter": "Szűrő szerkesztése",
    "Remove this filter": "Szűrő eltávolítása",
    "Apply filter to": "Szűrő alkalmazása erre:",
    "Filter on": "Szűrés erre:",
    "Human readable name of the filter": "Szűrő ember által olvasható neve",
    "Widget for the filter": "Widget a szűrőhöz",
    "Edit filter": "Szűrő szerkesztése",
    "Edit this field": "Mező szerkesztése",
    "all layers": "minden réteg",
    "single layer": "egyetlen réteg",
    "unset": "nincs megadva",
    "Filters will be displayed in the data browser to ease data selection.": "A szűrők az adatok böngészésekor fognak látszani, hogy megkönnyítsék az adatok kijelölését",
    "[key=\"value\"][key2=\"value2\"] (eg. [boundary=\"educational\"][name=\"Académie de Lyon\"])": "[kulcs=\"érték\"][kulcs2=\"érték2\"] (eg. [boundary=\"educational\"][name=\"Académie de Lyon\"])",
    "Field Name": "Mező neve",
    "Field Type": "Mező típusa",
    "Manage field": "Mező kezelése",
    "Add filter for this field": "Szűrő hozzáadása ehhez a mezőhöz",
    "Name cannot be empty.": "A név nem lehet üres",
    "Anonymous map": "Névtelen térkép",
    "Edit filter for this field": "Szűrő szerkesztése ennél a mezőnél",
    "Hey, you created a map without an account!": "Hahó, fiók nélkül hozott létre egy térképet+",
    "This map is anonymous, do you want to attach it to your account?": "Ez a térkép névtelen; szeretné a fiókjához társítani?",
    "The map has been upgraded to latest version, please save it.": "A térkép a legfrissebb verzióra frissült, mentsd el.",
    "Elevation has been added!": "Magasság hozzáadva",
    "Mapillary": "Mapillary",
    "Wikidata": "Wikidata",
    "Wikipedia contributors": "Wikipédia-közreműködők",
    "See on Wikipedia": "Lásd a Wikipédián",
    "Anonymous map: update who can see and edit it": "Névtelen térkép: frissítsd, hogy ki láthatja és ki szerkesztheti",
    "Login": "Bejelentkezés",
    "Manage filters": "Szűrők kezelése",
    "Map (all layers)": "Térkép (minden réteg)",
    "Add a filter for this field": "Szűrő hozzáadása ehhez a mezőhöz",
    ...
    "№": "№",
    "Layers": "Rétegek",
    "Datalayers’ permissions": "Adatrétegek engedélyei",
    "Group’s permissions": "Csoport engedélyei",
    "Layer’s permissions": "Réteg engedélyei",
    "This layer is a group": "Ez a réteg egy csoport",
    "Groups can have children layers, but cannot have data.": "Egy csoportnak lehetnek leszármazott rétegei, de a csoport adatokat nem tartalmazhat.",
    "Open in OpenStreetMap": "Megnyitás az OpenStreetMappel",
    "Add a group": "Csoport hozzáadása",
    "Are you sure you want to delete this field?": "Biztosan törli ezt a mezőt?",
    "Group": "Csoport",
    "Parent group": "Felettes csoport",
