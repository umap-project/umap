const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe egyedi magassággal (pixel): {{{https://iframe.url.com|magasság}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe egyedi magassággal és szélességgel (pixel): {{{https://iframe.url.com|magasság*szélesség}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Kép egyedi szélességgel (pixel): {{https://image.url.com|szélesség}}",
    ...
    "Link to…": "Link…",
    "Link with text: [[https://example.com|text of the link]]": "Link szöveggel: [[https://pelda.hu|szöveg]]",
    ...
    "Simple link: [[https://example.com]]": "Egyszerű link: [[https://pelda.hu]]",
