const locale = {
    ...
    "{area}&#8239;mi&sup2;": "{area}&#8239;μίλια&sup2;",
    "{area}&#8239;yd&sup2;": "{area}&#8239;γιάρδες&sup2;",
    ...
    "Exclusive choice": "Αποκλειστική επιλογή",
    "Yes/No": "Ναι/Όχι",
    "Add a field prior to create a filter.": "Προσθέστε ένα πεδίο πριν από τη δημιουργία ενός φίλτρου.",
    "Edit this filter": "Επεξεργασία αυτού του φίλτρου",
    "Remove this filter": "Αφαίρεση αυτού του φίλτρου",
    "Apply filter to": "Εφαρμογή του φίλτρο στο",
    "Filter on": "Ενεργοποίηση φίλτρου",
    "Human readable name of the filter": "Όνομα φίλτρου αναγνώσιμο από άνθρωπο",
    "Widget for the filter": "Widget για το φίλτρο",
    "Edit filter": "Επεξεργασία φίλτρου",
    "Edit this field": "Επεξεργασία αυτού του φίλτρου",
    "all layers": "όλα τα επίπεδα",
    "single layer": "μονή στρώση",
    "unset": "δεν ορίστηκε",
    "Filters will be displayed in the data browser to ease data selection.": "Τα φίλτρα θα εμφανίζονται στο πρόγραμμα περιήγησης δεδομένων για να διευκολύνουν την επιλογή τους.",
    ...
    "Field Type": "Είδος πεδίου",
    "Manage field": "Διαχείριση πεδίου",
    "Add filter for this field": "Προσθήκη φίλτρου για αυτό το πεδίο",
    "Name cannot be empty.": "Το όνομα δεν μπορεί να είναι κενό",
    "Anonymous map": "Ανώνυμος χάρτης",
    "Edit filter for this field": "Επεξεργασία φίλτρου για αυτό το πεδίο",
    "Hey, you created a map without an account!": "Γεια, δημιουργήσατε έναν χάρτη χωρίς λογαριασμό!",
    "This map is anonymous, do you want to attach it to your account?": "Αυτός ο χάρτης είναι ανώνυμος, θέλετε να τον επισυνάψετε στον λογαριασμό σας;",
    "The map has been upgraded to latest version, please save it.": "Ο χάρτης έχει αναβαθμιστεί στην πιο πρόσφατη έκδοση, παρακαλώ αποθηκεύστε τον.",
    "Elevation has been added!": "Προστέθηκε υψόμετρο!",
    "Mapillary": "Mapillary",
    "Wikidata": "Wikidata",
    "Wikipedia contributors": "Συνεισφέροντες στη Βικιπαίδεια",
    "See on Wikipedia": "Δείτε στη Βικιπαίδεια",
    "Anonymous map: update who can see and edit it": "Ανώνυμος χάρτης: ενημερώστε ποιος μπορεί να τον δει και να τον επεξεργαστεί",
    "Login": "Σύνδεση",
    "Manage filters": "Διαχείριση φίλτρων",
    "Map (all layers)": "Χάρτης (όλα τα επίπεδα)",
    "Add a filter for this field": "Προσθήκη φίλτρου για αυτό το πεδίο",
    ...
    "Yes / No": "Ναι / Όχι",
    "Select field to compute intensity": "Επιλογή πεδίου για τον υπολογισμό της έντασης",
    "Optional intensity field to compute heatmap": "Προαιρετικό πεδίο έντασης για τον υπολογισμό του χάρτη θερμότητας",
    "All layers": "Όλα τα επίπεδα",
    "Comma separated list of values": "Λίστα τιμών διαχωρισμένων με κόμμα",
    "Share": "Διαμοιρασμός",
    "Customized link": "Προσαρμοσμένος σύνδεσμος",
    "Iframe": "Iframe",
    "№": "№",
    "Layers": "Layers",
