const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Predmet Iframe z višino po meri (v točkah): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Predmet Iframe z višino in širino po meri (v točkah): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Slika s širino po meri (v tpčkah): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Slika: {{https://image.url.com}}",
    ...
    "Link to…": "Povezava z ...",
    "Link with text: [[https://example.com|text of the link]]": "Povezava z besedilom: [[https://primer.com|besedilo povezave]]",
    ...
    "Simple link: [[https://example.com]]": "Enostavna povezava: [[https://primer.com]]",
    "Simplify": "Poenostavi",
