const locale = {
    ...
    "Comma, tab or semi-colon separated values. SRS WGS84 is implied. Only Point geometries are imported. The import will look at the column headers for any mention of «lat» and «lon» at the beginning of the header, case insensitive. All other column are imported as properties.": "Komma-, Tabulator- oder Semikolon-getrennte Werte. WGS84 wird als Bezugssystem angenommen. Nur Punktgeometrien werden importiert. Dabei wird nach Spaltenüberschriften beginnend mit „lat“ und „long“ gesucht (unabhängig von Groß- oder Kleinschreibung). Alle anderen Spalten werden als Merkmale importiert.",
    ...
    "How much to simplify the polyline on each zoom level (more = better performance and smoother look, less = more accurate)": "Wie stark Linien mit jeder Zoomstufe vereinfacht werden (mehr = bessere Leistung und glatteres Aussehen, weniger = präziser)",
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe mit benutzerdefinierter Höhe (in px): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe mit benutzerdefinierter Höhe und Breite (in px): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    ...
    "opacity": "Deckkraft",
    "Opacity": "Deckkraft",
    "Open current feature on load": "Aktuelles Merkmal beim Laden öffnen",
    ...
    "The name of the property to use as feature label (eg.: \"nom\"). You can also use properties inside brackets to use more than one or mix with static content (eg.: \"&lcub;name&rcub; in &lcub;place&rcub;\")": "Der Name des Attributs, das zur Beschriftung benutzt werden soll (z. B. „name“). Es können auch Eigenschaften in Klammern benutzt werden, um mehr als eine zu verwenden oder mit statischem Inhalt zu mischen (z. B.: „&lcub;name&rcub; in &lcub;place&rcub;“)",
    ...
    "Verify remote URL": "Entfernte URL überprüfen",
    "Versions": "Versionen",
    ...
    "width": "Breite",
    "Will be displayed in the bottom right corner of the map": "Wird in der rechten unteren Ecke der Karte angezeigt",
    ...
    "Zoom level for automatic zooms": "Zoomstufe für automatischen Zoom",
    ...
    "Cannot load remote data for layer \"{layer}\" with url \"{url}\"": "Laden der externen Daten fehlgeschlagen für Ebene \"{layer}\" mit der URL \"{url}\"",
    "Cannot parse remote data for layer \"{layer}\" with url \"{url}\"": "Zerlegen/parsen der externen Daten fehlgeschlagen für Ebene \"{layer}\" mit der URL \"{url}\"",
