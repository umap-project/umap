var locale = {
    ...
    "Allow scroll wheel zoom?": "Möchtest du Zoomen mit dem Mausrad erlauben?",
    ...
    "Center map on your location": "Die Karte auf deinem Standort ausrichten",
    ...
    "Start editing": "Beginne mit der Bearbeitung",
    ...
    "Zoom to layer extent": "Auf Ebenenausdehnung zommen",
    ...
    "Supported variables that will be dynamically replaced": "Unterstützte Variablen, welche dynamisch ersetzt werden",
    ...
    "You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each markers.": "Du kannst variable Elementeigenschaften verwenden: z.B.: bei „http://myserver.org/images/{name}.png“, wird die {name}-Variable ersetzt durch den „name“-Wert des jeweiligen Markers.",
    ...
    "Credits": "Credits",
    "Only visible features will be downloaded.": "Nur eingeblendete Elemente werden heruntergeladen.",
    ...
    "Iframe export options": "Iframe Exportoptionen",
    ...
    "Override heatmap radius (default 25)": "Heatmapradius überschreiben (Standard: 25)",
    "Proxy request": "Proxyanforderung",
    "Table": "Tabelle",
    "To use if remote server doesn't allow cross domain (slower)": "Zu nutzen wenn der Zielserver kein Cross-Origin Resource Sharing (CORS) erlaubt (langsamer).",
    ...
    "Do you want to display a caption bar?": "Mächtest du eine Überschrift (Fußzeile) anzeigen?",
    ...
    "Woops! Someone else seems to have edited the data. You can save anyway, but this will erase the changes made by others.": "Hoppla! Jemand anders hat die Daten bearbeitet. Du kannst trotzdem speichern, aber dies wird Änderungen, welche andere Personen vorgenommen haben, löschen.",
    ...
    "Delete this shape": "Diese Form löchen",
    ...
    "Transfer shape to edited feature": "Überführe Form zu Element bearbeiten",
    "next": "weiter",
    "previous": "zurück",
    ...
    "Extract shape to separate feature": "Extrahiere Form zu getrennten Element",
    ...
    "Advanced transition": "Erweiterter Übergang",
    ...
    "Save this location as new feature": "Diesen Ort als neue Funktion speichern",
    "Search location": "Ort suchen",
    "Set URL": "URL festlegen",
    "Shape properties": "Formeigenschaften",
    "Simplify": "Vereinfachen",
    "Sort key": "Sortierschlüssel",
    "The name of the property to use as feature label (ex.: \"nom\")": "Den Name des Merkmals als Elementbezeichnung verwenden (z.B.: \"Name\")",
    ...
    "Clone this feature": "Diese Funktion klonen",
    ...
    "Only display label on mouse hover": "Beschriftung nur beim Überfahren mit der Maus anzeigen",
    ...
    "Set it to false to hide this layer from the slideshow, the data browser, the popup navigation…": "Setze es auf Nein, um diese Ebene in der Slideshow, im Datenbrowser, in der Popup-Navigation,... auszublenden.",
