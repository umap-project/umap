const locale = {
    ...
    "№": "№",
    "Layers": "Capas",
    "Datalayers’ permissions": "Permisos de las capas de datos",
    "Group’s permissions": "Permisos del grupo",
    "Layer’s permissions": "Permisos de la capa",
    "This layer is a group": "Esta capa es un grupo",
    "Groups can have children layers, but cannot have data.": "Los grupos pueden contener capas secundarias, pero no pueden contener datos",
    "Open in OpenStreetMap": "Abrir en OpenStreetMap",
    "Add a group": "Agregar un grupo",
    "Are you sure you want to delete this field?": "¿Seguro que deseas eliminar este campo?",
    "Group": "Grupo",
