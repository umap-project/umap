var locale = {
    ...
    "You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each markers.": "Puede utilizar las propiedades del elemento como variables. Ej.: con \"http://miservidor.org/images/{name}.png\", la variable {name} será reemplazada con el valor \"name\" de cada uno de los marcadores.",
    ...
    "mi": "mi",
    "miles": "millas",
    "nautical miles": "millas naúticas",
    ...
    "Only display label on mouse hover": "Sólo mostrar la etiqueta al pasar el ratón",
