const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe con altura personalizada (en px): {{{https://iframe.url.com|altura}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe con altura y ancho personalizados (en px): {{{https://iframe.url.com|altura*ancho}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Imagen con ancho personalizado (en px): {{https://image.url.com|ancho}}",
    ...
    "Link to…": "Enlace a...",
    "Link with text: [[https://example.com|text of the link]]": "Enlace con texto: [[https://example.com|texto del enlace]]",
