const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe kohandatud kõrgusega (pikslites): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe kohandatud kõrguse ja laiusega (pikslites): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Pilt kohandatud laiusega (pikslites): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Pilt: {{https://image.url.com}}",
    ...
    "Link to…": "Lingi…",
    "Link with text: [[https://example.com|text of the link]]": "Link tekstiga: [[https://example.com|lingi tekst]]",
    ...
    "Simple link: [[https://example.com]]": "Link: [[https://example.com]]",
