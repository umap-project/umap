const locale = {
    ...
    "Opacity": "不透明度",
    "Star this map": "地圖打星號",
    "Symbol can be either a unicode character or an URL. You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each marker.": "屬性標誌可以是任一Unicode字元或URL地址。你可以使用項目屬性作為變數，如：\"http://myserver.org/images/{name}.png\" 北一URL中，變數 {name} 將會由各標記的 \"name\" 數值取代。",
    "Direct link": "直接連結",
    "Export options": "匯入選項",
