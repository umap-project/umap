const locale = {
    ...
    "Do you want to display caption menus?": "你想要顯示標題選單嗎？",
    ...
    "iframe": "內嵌頁框",
    "Iframe: {{{https://iframe.url.com}}}": "內嵌頁框：{{{https://iframe.url.com}}}",
    ...
    "Invalid latitude or longitude": "無效的經度或緯度",
    ...
    "Link to…": "連結至...",
    "Link with text: [[https://example.com|text of the link]]": "有文字的連結：[[https://example.com|連結的文字]]",
    ...
    "opacity": "不透明度",
    "Opacity": "不透明度",
    "Open current feature on load": "載入開啟目前圖徵",
    "Open link in…": "開啓連結於...",
    ...
    "Permalink": "永久連結",
    "Permanent credits background": "永久工作人員背景",
    "Permanent credits": "永久工作人員名單",
    ...
    "The name of the property to use as feature unique identifier.": "要當成圖徵唯一識別碼的屬性名稱。",
    ...
    "User content credits": "使用者內容貢獻名單",
    ...
    "Will be permanently visible in the bottom left corner of the map": "會永久顯示在地圖左下角",
    ...
    "{area}&#8239;mi&sup2;": "{area} 平方英哩",
    "{area}&#8239;yd&sup2;": "{area} 平方英呎",
    ...
    "No result": "沒有結果",
    "Data browser": "資料瀏覽器",
    "When providing an URL, uMap can copy the remote data in a layer, or add this URL as remote source of the layer. In that case, data will always be fetched from that URL, and thus be up to date, but it will not be possible to edit it inside uMap.": "當你提供 URL，uMap 能夠複製遠端資料成為圖層，或是用這一 URL 來當作遠端來源的圖層。在這一例子，資料總能從 URL 取得，能夠維持即時狀態，但仍不能直接在 uMap 裡編輯。",
    ...
    "OK": "確認",
    "Cancel": "取消",
    "Attach map to a team": "指定地圖到團隊",
    "Display the polygon inverted": "顯示反向選擇的多邊形",
    "Proportional circles": "部分圓圈",
    "Property name to compute circles": "來計算圓圈的屬性名稱",
    "Min circle radius": "最小圓圈半徑",
    "Max circle radius": "最大圓圈半徑",
    "Display the open browser control": "顯示開啟的瀏覽器控制",
    "Copy as GeoJSON": "以 GeoJSON 複製",
    "Please zoom in to edit the geometry": "請切換到編輯的幾何",
    "New map": "新地圖",
    "My maps": "我的地圖",
    "My teams": "我的團隊",
    "My profile": "我的個人檔案",
    "Type new owner's username": "輸入新擁有者名稱",
    "Type editor's username": "輸入編輯者名稱",
    "Map": "地圖",
    "Manage collaborators": "管理共編者",
    ...
    "Disconnected": "已經離線了",
    "You must be logged in": "你必須登入",
    "on hover": "滑動過去時",
    "Cannot load remote data for layer \"{layer}\" with url \"{url}\"": "無法用網址 \"{url}\" 為圖層 \"{layer}\"\" 載入遠端資料",
    "Cannot parse remote data for layer \"{layer}\" with url \"{url}\"": "無法用網址 \"{url}\" 為圖層 \"{layer}\" 解析遠端資料",
    "Import failed: invalid data": "匯入失敗：無效的資料",
    "Anonymous": "暱名",
    "created at {date}": "在 {date} 創建",
    "modified at {date}": "在 {date} 變更",
    "Default zoom": "預設縮放大小",
    ...
    "№": "№",
    "Layers": "圖層",
    "Datalayers’ permissions": "資料圖層權限",
    "Group’s permissions": "群組權限",
    "Layer’s permissions": "圖層權限",
    "This layer is a group": "這個圖層是群組",
    "Groups can have children layers, but cannot have data.": "群組可以有子圖層，但不能有資料。",
    "Open in OpenStreetMap": "在開放街圖開啟",
    "Add a group": "新增群組",
    "Are you sure you want to delete this field?": "您確定您要刪除這一欄位？",
    "Group": "群組",
    "Parent group": "父群組",
