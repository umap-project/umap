const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "自訂 iframe 高度 (以 px 為單位): {{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "自訂 iframe 高度和寬度 (以 px 為單位)：{{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "自訂圖像的寬度（像素）: {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "圖像: {{https://image.url.com}}",
    "Import data": "匯入資料",
    ...
    "Link to…": "連結至...",
    "Link with text: [[https://example.com|text of the link]]": "帶有超連結的文字: [[https://example.com|text of the link]]",
