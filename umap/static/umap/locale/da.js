const locale = {
    ...
    "*single star for italic*": "*enkelt stjerne for kursiv*",
    ...
    "Activate slideshow mode": "Aktiver slideshow-tilstand",
    ...
    "Ball": "Knappenål",
    "Bring feature to center": "Bring objektet i centrum",
    ...
    "Choropleth breakpoints": "Koropletbrudpunkter",
    "Choropleth classes": "Koropletklasser",
    "Choropleth color palette": "Koropletfarvepalette",
    "Choropleth mode": "Koroplettilstand",
    ...
    "Custom overlay": "Brugerdefineret overlejring",
    "dash array": "stiplet række",
    "Data is browsable": "Data kan gennemses",
    "Datalayers": "Datalag",
    "Default interaction options": "Standard-indstillinger for interaktion",
    ...
    "Do you want to display a caption bar?": "Vil du vise en bjælke med med kortekst?",
    ...
    "Error in the overlay URL": "Fejl i URL til baggrundsoverlejring",
    ...
    "fill opacity": "udfyldningsuigennemskinnelighed",
    "fill": "udfyldning",
    ...
    "Go to the homepage": "Gå til hjemmesiden",
    ...
    "icon opacity": "ikonets uigennemskinnelighed",
    ...
    "Set it to false to hide this layer from the slideshow, the data browser, the popup navigation…": "Slå den fra for at skjule dette lag fra slideshowet, databrowseren, popup-navigeringen…",
    ...
    "Map advanced properties": "Kort avancerede egenskaber",
    ...
    "Type area name, or let empty to load data in current map view": "Skriv områdets navn, eller lad det være tomt for at indlæse data i den aktuelle kortvisning",
    ...
    "Tags": "Tags",
    "Geocode": "Geokode",
    "Display the back to home icon": "Vis ikonet for tilbage til hjem",
