const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe با ارتفاع دلخواه (به px):\n{{{https://iframe.url.com|height}}}",
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "iframe با ارتفاع و عرض دلخواه (به px):\n{{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe:\n{{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "تصویر با عرض دلخواه (به px):\n{{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "تصویر:\n{{https://image.url.com}}",
    ...
    "Link to…": "پیوند به…",
    "Link with text: [[https://example.com|text of the link]]": "پیوند با متن:\n[[https://example.com|text of the link]]",
    ...
    "Simple link: [[https://example.com]]": "پیوند ساده:\n[[https://example.com]]",
    "Simplify": "ساده‌سازی",
    ...
    "Import helpers:": "یاری‌گران درون‌برد:",
