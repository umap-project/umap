var locale = {
    ...
    "The zoom and center have been set.": "بزرگنمایی و مرکز تنظیم شده است.",
    ...
    "Comma separated list of properties to use for checkbox filtering": "فهرستی از ویژگی‌های جدا شده با کاما برای استفاده برای فیلتر کردن کادر تأیید",
    "Data filters": "فیلتر داده‌ها",
    ...
    "No results for these filters": "برای این فیلترها هیچ نتیجه‌ای وجود ندارد",
