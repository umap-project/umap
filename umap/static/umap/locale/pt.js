const locale = {
    ...
    "Iframe with custom height and width (in px): {{{https://iframe.url.com|height*width}}}": "Iframe com altura e largura personalizados (em px): {{{https://iframe.url.com|height*width}}}",
    "iframe": "iframe",
    "Iframe: {{{https://iframe.url.com}}}": "Iframe: {{{https://iframe.url.com}}}",
    "Image with custom width (in px): {{https://image.url.com|width}}": "Imagem com largura personalizada (em px): {{https://imagem.url.com|largura}}",
    ...
    "Link with text: [[https://example.com|text of the link]]": "Hiperligação com texto: [[https://exemplo.com|texto do link]]",
