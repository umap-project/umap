const locale = {
    ...
    "Iframe with custom height (in px): {{{https://iframe.url.com|height}}}": "Iframe su nurodytu aukščiu (pikseliais):  {{{https://iframe.url.com|height}}}",
    ...
    "Image with custom width (in px): {{https://image.url.com|width}}": "Paveikslo plotis (pikseliais): {{https://image.url.com|width}}",
    "Image: {{https://image.url.com}}": "Paveikslas: {{https://image.url.com/image.jpeg}}",
    ...
    "Link to…": "Link to…",
    "Link with text: [[https://example.com|text of the link]]": "Nuoroda tekstui:: [[https://example.com|nuorodos tekstas]]",
    ...
    "Simple link: [[https://example.com]]": "Paprasta nuoroda: [[https://example.com]]",
    "Simplify": "Simplify",
