var locale = {
    ...
    "Background overlay url": "URL du fond de carte",
    "Ball": "Épingle",
    ...
    "Custom overlay": "Fond avec transparence",
    ...
    "Error in the overlay URL": "Erreur dans l'URL du fond de carte",
    ...
    "Symbol can be either a unicode caracter or an URL. You can use feature properties as variables: ex.: with \"http://myserver.org/images/{name}.png\", the {name} variable will be replaced by the \"name\" value of each marker.": "Utilisez soit un caractère unique soit une URL. Vous pouvez utiliser des propriétés des marqueurs comme variables : par exemple avec \"http://myserver.org/images/{name}.png\", la variable {name} sera remplacée par la valeur du \"name\" de chacun des marqueurs.",
