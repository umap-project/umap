const locale = {
    ...
    "Link to…": "Lien vers…",
    "Link with text: [[https://example.com|text of the link]]": "Lien avec texte : [[https://example.com|titre du lien]]",
    "Long credits": "Crédit",
    "Longitude": "Longitude",
    ...
    "Simple link: [[https://example.com]]": "Lien simple : [[https://example.com]]",
    "Simplify": "Simplifier",
    ...
    "The name of the property to use as feature label (eg.: \"nom\"). You can also use properties inside brackets to use more than one or mix with static content (eg.: \"&lcub;name&rcub; in &lcub;place&rcub;\")": "Nom de la propriété utilisée pour le libellé (ex.: \"nom\"). Il est possible d'utiliser des propriétés entre accolades pour en utiliser plusieurs ou ajouter du texte (ex.: \"&lcub;nom&rcub; à &lcub;lieu&rcub;\")",
    ...
    "Edit map name and caption": "Modifier le nom et la légende",
    "Map advanced properties": "Propriétés avancées de la carte",
    ...
    "Scale map": "Choisir l'échelle",
    "portrait": "portrait",
    "landscape": "paysage",
    "Print": "Imprimer",
    "Preparing the print…": "Impression en préparation…",
    "Large Circle": "Grand Cercle",
    "Icon size": "Taille de l'icône",
    "Will only affect raw and large circle icons.": "Affecte seulement les images brutes et les grands cercles.",
    "Route": "Route",
    "Display the print control": "Afficher le bouton d'impression",
    "Compute isochrone from here": "Isochrone depuis ce point",
    "Route settings": "Réglages de la route",
    ...
    "Fastest": "Plus rapide",
    "Shortest": "Plus court",
    "Max time (in minutes)": "Temps max (en minutes)",
    ...
    "№": "№",
    "Layers": "Calques",
    "Datalayers’ permissions": "Permissions des calques",
    "Group’s permissions": "Permissions du groupe",
    "Layer’s permissions": "Permissions du calque",
    "This layer is a group": "Ce calque est un groupe",
    "Groups can have children layers, but cannot have data.": "Les groupes peuvent avoir des calques enfants, mais pas de données.",
    "Open in OpenStreetMap": "Ouvrir dans OpenStreetMap",
    "Add a group": "Ajouter un groupe",
    "Are you sure you want to delete this field?": "Supprimer ce champ pour vrai ?",
    "Group": "Groupe",
