...
def test_replace_user(user, user2, map, team):
    ...
    team.users.add(user)
    team.save()
    call_command("replace_user", user.username, user2.username, "--dry-run")
    ...
    call_command("replace_user", user.username, user2.username)
